// icon:repo-clone-16 | Octicons https://primer.style/octicons/ | Github Primer

function IconRepoClone16(props: React.SVGProps<SVGSVGElement>) {
  return (
...
export default IconRepoClone16
