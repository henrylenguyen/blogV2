// icon:google-analytics | Material Design Icons https://materialdesignicons.com/ | Austin Andrews

function IconGoogleAnalytics(props: React.SVGProps<SVGSVGElement>) {
  return (
